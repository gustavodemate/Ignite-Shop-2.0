...
import { ImageContainer, ProductContainer, SuccessContainer } from "../styles/pages/success";
...
export default function Success({ customerName, products, productsImages }: SuccessProps) {
